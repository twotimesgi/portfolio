  ...
  return (
    <div className="hover:bg-white/20 hover:shadow-lg rounded-lg w-full transition-all group ">
      ...
      <div className="text-slate-400 sm:w-[150px] w-full pt-1 text-nowrap shrink-0 ">
        <Image src={image} className="rounded-md border-[3px] border-slate-300 group-hover:border-slate-500 transition-all group-hover:scale-105 w-[160px] h-[90px] md:w-[300px] md:h-[90px] object-cover object-left" width={300} alt={`${title} Screenshot`} />
      </div>
      <div>
